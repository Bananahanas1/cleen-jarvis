...
def test_connection():
    ...
    try:
        req = urllib.request.Request(
            "http://localhost:8000/api/jarvis/summary",
...
- GET /api/jarvis/recall?q=topic - Recall knowledge about a topic
- GET /api/jarvis/search?q=query - Full-text search all knowledge
- POST /api/jarvis/remember - Store knowledge (body: {"text":"...","source":"claude"})
